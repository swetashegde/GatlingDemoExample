...
class RecordedSimulationForDemo extends Simulation {
	...
	val scn = scenario("RecordedSimulationForDemo")
		.exec(http("request_0")
			...
			.post(uri2 + "/view")
			.headers(headers_15)
			.body(RawFileBody("test/scala/recordedsimulationfordemo/0015_request.json")),
            http("request_16")
		...
		.exec(http("request_17")
			...
			.post(uri2 + "/addtocart")
			.headers(headers_15)
			.body(RawFileBody("test/scala/recordedsimulationfordemo/0018_request.json"))))
		.pause(88)
		.exec(http("request_19")
			...
			.post(uri2 + "/viewcart")
			.headers(headers_15)
			.body(RawFileBody("test/scala/recordedsimulationfordemo/0040_request.json")),
            http("request_41")
			.options(uri2 + "/view")
			.headers(headers_14),
            http("request_42")
			.post(uri2 + "/view")
			.headers(headers_15)
			.body(RawFileBody("test/scala/recordedsimulationfordemo/0042_request.json")),
            http("request_43")
			.get("/imgs/galaxy_s6.jpg")
			.headers(headers_4)))
